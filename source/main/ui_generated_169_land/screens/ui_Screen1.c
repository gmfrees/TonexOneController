...
// LVGL version: 8.3.11
// Project name: TonexOneController_1.69land_pj
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_PresetHeadingLabel, -21);
    lv_obj_set_y(ui_PresetHeadingLabel, 67);
    ...
    lv_obj_set_style_transform_angle(ui_PresetHeadingLabel, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BPMLabel = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_BPMLabel, 55);
    lv_obj_set_height(ui_BPMLabel, 19);
    lv_obj_set_x(ui_BPMLabel, -141);
    lv_obj_set_y(ui_BPMLabel, -73);
    ...
    lv_obj_set_style_transform_angle(ui_BPMLabel, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BPM = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_BPM, 57);
    lv_obj_set_height(ui_BPM, 33);
    lv_obj_set_x(ui_BPM, -113);
    ...
    lv_obj_set_style_transform_angle(ui_BPM, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_CStatus = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_CStatus, 28);
    lv_obj_set_height(ui_CStatus, 28);
    lv_obj_set_x(ui_CStatus, -63);
    lv_obj_set_y(ui_CStatus, 145);
    ...
    lv_obj_set_style_transform_angle(ui_CStatus, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MStatus = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_MStatus, 28);
    lv_obj_set_height(ui_MStatus, 28);
    lv_obj_set_x(ui_MStatus, -30);
    lv_obj_set_y(ui_MStatus, 145);
    ...
    lv_obj_set_style_transform_angle(ui_MStatus, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_DStatus = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_DStatus, 28);
    lv_obj_set_height(ui_DStatus, 28);
    lv_obj_set_x(ui_DStatus, -63);
    lv_obj_set_y(ui_DStatus, 112);
    ...
    lv_obj_set_style_transform_angle(ui_DStatus, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_RStatus = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_RStatus, 28);
    lv_obj_set_height(ui_RStatus, 28);
    lv_obj_set_x(ui_RStatus, -30);
    lv_obj_set_y(ui_RStatus, 112);
    ...
    lv_obj_set_style_transform_angle(ui_RStatus, -900, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BottomContainer = lv_obj_create(ui_Screen1);
    lv_obj_remove_style_all(ui_BottomContainer);
    lv_obj_set_width(ui_BottomContainer, 270);
    lv_obj_set_height(ui_BottomContainer, 130);
    lv_obj_set_x(ui_BottomContainer, 123);
    lv_obj_set_y(ui_BottomContainer, 198);
    ...
    lv_obj_set_style_transform_angle(ui_BottomContainer, -900, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_PresetHeadingLabel2, 245);
    lv_obj_set_height(ui_PresetHeadingLabel2, 110);
    ...
    lv_obj_set_width(ui_TopPanel, 280);
    lv_obj_set_height(ui_TopPanel, 38);
    lv_obj_set_x(ui_TopPanel, 20);
    lv_obj_set_y(ui_TopPanel, 158);
    ...
    lv_obj_set_style_transform_angle(ui_TopPanel, -900, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_USBStatusOK, 104);
    ...
    lv_img_set_zoom(ui_USBStatusOK, 200);
    ...
    lv_obj_set_x(ui_USBStatusFail, 104);
    ...
    lv_img_set_zoom(ui_USBStatusFail, 200);
    ...
    lv_obj_set_x(ui_BTStatusDisconn, 59);
    ...
    lv_img_set_zoom(ui_BTStatusDisconn, 200);
    ...
    lv_obj_set_x(ui_BTStatusConn, 59);
    ...
    lv_img_set_zoom(ui_BTStatusConn, 200);
    ...
    lv_obj_set_x(ui_WiFiStatusDisconn, 19);
    ...
    lv_img_set_zoom(ui_WiFiStatusDisconn, 200);
    ...
    lv_obj_set_x(ui_WiFiStatusConn, 19);
    ...
    lv_img_set_zoom(ui_WiFiStatusConn, 200);
