...
enum ValetonParameters
{
    ...
    VALETON_PARAM_EFFECT_SLOT_0,
    VALETON_PARAM_EFFECT_SLOT_1,
    VALETON_PARAM_EFFECT_SLOT_2,
    VALETON_PARAM_EFFECT_SLOT_3,
    VALETON_PARAM_EFFECT_SLOT_4,
    VALETON_PARAM_EFFECT_SLOT_5,
    VALETON_PARAM_EFFECT_SLOT_6,
    VALETON_PARAM_EFFECT_SLOT_7,
    VALETON_PARAM_EFFECT_SLOT_8,
    VALETON_PARAM_EFFECT_SLOT_9,
    ...
    VALETON_GLOBAL_RECORD_LEVEL, 
    VALETON_GLOBAL_MONITOR_LEVEL, 
    VALETON_GLOBAL_BT_LEVEL, 
