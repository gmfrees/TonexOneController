...
static tTonexParameter TonexParameters[TONEX_GLOBAL_LAST] = 
{
    ...
    {0,      0,      17,   "MOD CH T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_MODULATION_CHORUS_TS,
    ...
    {0,      0,      17,   "MOD TR T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_MODULATION_TREMOLO_TS,
    ...
    {0,      0,      17,   "MOD PH T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_PHASER_TS,
    ...
    {0,      0,      17,   "MOD FL T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_FLANGER_TS,
    ...
    {0,      0,      17,   "MOD RO T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_ROTARY_TS,
    ...
    {0,      0,      17,   "DLY DG T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_DELAY_DIGITAL_TS,
    ...
    {0,      0,      17,   "DLY TA T", TONEX_PARAM_TYPE_RANGE},            // TONEX_PARAM_DELAY_TAPE_TS,
