...
- Connect the USB-C port on the Lilygo T-Display S3 board to the ToneX One USB-C port
- Connect 5 volts DC to the power input jack that you soldered in the first step
- Switch on the power supply
- The USB port on this platform with not power the Tonex One. Connect 9 volts DC to the Tonex's power input
<br><br>
...
The T-Display board has a maximum of 5 volts input.
